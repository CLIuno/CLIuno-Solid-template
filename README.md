...
```bash
docker pull iru44/solidjs-template
```
...
```bash
docker run -p 5000:5000 iru44/solidjs-template
```
...
```bash
git clone https://github.com/CLIuno/CLIuno-Solid-template.git
```
